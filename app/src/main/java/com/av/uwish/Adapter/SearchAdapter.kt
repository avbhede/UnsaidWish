...
class SearchAdapter(internal var context: Context, resourse: Int, internal var hisModel: ArrayList<InboxModel>) : ArrayAdapter<InboxModel>(context, resourse, hisModel) {
